        ...
        return (
          ...
          >
            <Rect
              ...
              height={siteHeight-1} 
              fill={/* isCurrentPosition ? '#fafafa' :  */floorColors[site.floor < 0 ? 0 : site.floor].color}
              onPress={() => onSelectSite && onSelectSite(site, area)}
            />
            <Text fill='#000' textAnchor='middle' x={site.flag ? siteWidth :siteWidth/2} y={siteHeight/2+4}>
              { postionName }
            </Text> 
          </G>
        )
